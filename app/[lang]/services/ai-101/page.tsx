...
export default function AI101Page() {
  ...
  const services = [
    t('services.ai101.services.0'),
    t('services.ai101.services.1'),
    t('services.ai101.services.2'),
    t('services.ai101.services.3'),
    t('services.ai101.services.4'),
    t('services.ai101.services.5'),
    t('services.ai101.services.6'),
    t('services.ai101.services.7'),
  ]

  const processSteps = [
    {
      title: t('services.ai101.processSteps.0.title'),
      description: t('services.ai101.processSteps.0.description'),
    },
    {
      title: t('services.ai101.processSteps.1.title'),
      description: t('services.ai101.processSteps.1.description'),
    },
    {
      title: t('services.ai101.processSteps.2.title'),
      description: t('services.ai101.processSteps.2.description'),
    },
    {
      title: t('services.ai101.processSteps.3.title'),
      description: t('services.ai101.processSteps.3.description'),
    },
  ]

  const metrics = [
    t('services.ai101.metrics.0'),
    t('services.ai101.metrics.1'),
    t('services.ai101.metrics.2'),
    t('services.ai101.metrics.3'),
    t('services.ai101.metrics.4'),
  ]
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-12 h-12 rounded-lg bg-[#2D1BB8]/[0.08] flex items-center justify-center">
              <Brain className="w-6 h-6 text-[#2D1BB8]" />
            </div>
            <Link
              href={`/${lang}/services`}
      ...
      <section className="py-16 sm:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-[#F8F7FF] rounded-xl p-8 sm:p-12 mb-16">
            <h2 className="text-2xl font-bold text-[#0F0A2E] mb-8">Training Topics</h2>
      ...
      <section className="bg-[#2D1BB8] text-white py-16 sm:py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-blue-100 mb-8">
            Let&apos;s empower your team with practical AI skills that drive immediate results.
          </p>
          <Link
            href={`/${lang}/contact`}
