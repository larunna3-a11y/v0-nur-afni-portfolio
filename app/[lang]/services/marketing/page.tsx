...
export default function MarketingPage() {
  ...
  const services = [
    t('services.marketing.services.0'),
    t('services.marketing.services.1'),
    t('services.marketing.services.2'),
    t('services.marketing.services.3'),
    t('services.marketing.services.4'),
    t('services.marketing.services.5'),
    t('services.marketing.services.6'),
    t('services.marketing.services.7'),
  ]

  const processSteps = [
    {
      title: t('services.marketing.processSteps.0.title'),
      description: t('services.marketing.processSteps.0.description'),
    },
    {
      title: t('services.marketing.processSteps.1.title'),
      description: t('services.marketing.processSteps.1.description'),
    },
    {
      title: t('services.marketing.processSteps.2.title'),
      description: t('services.marketing.processSteps.2.description'),
    },
    {
      title: t('services.marketing.processSteps.3.title'),
      description: t('services.marketing.processSteps.3.description'),
    },
  ]

  const metrics = [
    t('services.marketing.metrics.0'),
    t('services.marketing.metrics.1'),
    t('services.marketing.metrics.2'),
    t('services.marketing.metrics.3'),
    t('services.marketing.metrics.4'),
  ]
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-12 h-12 rounded-lg bg-[#2D1BB8]/[0.08] flex items-center justify-center">
              <TrendingUp className="w-6 h-6 text-[#2D1BB8]" />
            </div>
            <Link
              href={`/${lang}/services`}
          ...
          <p className="text-lg text-[#2D1BB8] font-semibold mb-4">
            {t('services.marketing.subtitle')}
          </p>
          <p className="text-lg text-[#4B4680] max-w-3xl leading-relaxed">
            {t('services.marketing.heroDescription')}
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-3 gap-12 mb-16">
            <div className="lg:col-span-2">
              <h2 className="text-3xl font-bold text-[#0F0A2E] mb-6">
                {t('services.marketing.whyChoose')}
              </h2>
              <p className="text-lg text-[#4B4680] leading-relaxed mb-6">
                {t('services.marketing.whyDescription')}
              </p>
          ...
          <div className="mb-16">
            <h2 className="text-2xl font-bold text-[#0F0A2E] mb-8">
              {t('services.marketing.processTitle')}
            </h2>
          ...
          <div className="bg-[#F8F7FF] rounded-xl p-8 sm:p-12">
            <h2 className="text-2xl font-bold text-[#0F0A2E] mb-8">
              {t('services.marketing.metricsTitle')}
            </h2>
            <div className="grid sm:grid-cols-2 gap-6">
      ...
      <section className="bg-[#2D1BB8] text-white py-16 sm:py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-blue-100 mb-8">
            Let&apos;s build a scalable marketing system that drives measurable growth.
          </p>
          <Link
            href={`/${lang}/contact`}
