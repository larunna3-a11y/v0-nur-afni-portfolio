      ...
      <section className="bg-[#2D1BB8] py-16 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          <div className="mt-8 flex flex-wrap gap-6">
            ...
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-4">
              <p className="text-3xl font-bold text-white">Rp24M → Rp760M</p>
              <p className="text-sm text-[#9B97C0]">Monthly Revenue</p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-4">
              <p className="text-3xl font-bold text-white">19 Months</p>
              <p className="text-sm text-[#9B97C0]">Campaign Period</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="text-center p-6">
              ...
              <p className="text-2xl font-bold text-[#0F0A2E]">Sep 24 - Apr 26</p>
              <p className="text-sm text-[#9B97C0]">Campaign Duration</p>
            </div>
          </div>
        </div>
      </section>
