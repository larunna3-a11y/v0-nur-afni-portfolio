...
export const metadata = {
  title: 'Marketing — Work With Me — Nur Afni',
  description: 'Marketplace growth, paid advertising, content commerce, and performance optimization for Indonesian brands.',
}

const services = [
  { name: 'Marketplace Launch', description: 'Full setup and activation across Shopee, Tokopedia, and TikTok Shop from day one.', price: 'Starting from Rp5M' },
  { name: 'Marketplace Growth', description: 'Ongoing monthly management and optimization to scale revenue month over month.', price: 'Starting from Rp10M/month', badge: 'Most Popular' },
  { name: 'Full Digital Marketing', description: 'End-to-end digital marketing across every channel — social, ads, marketplace, and content.', price: 'Custom Quote' },
]

const highlights = [
  'Shopee, Tokopedia, TikTok Shop, Lazada, Blibli',
  'Meta Ads & TikTok Ads management',
  'Shopee CPAS campaigns',
  'Affiliate & creator strategy',
  'LIVE commerce coordination',
  'Monthly GMV & ROAS reporting',
...
const featuredProjects = [
  ...
  { name: 'Ecommerce Growth', category: 'E-commerce Optimization', href: '/portfolio/ecommerce-growth' },
]
...
export default function MarketingPage() {
  return (
    <div className="pt-16">
      <ServiceHero
        title="Marketing"
        subtitle="Helping brands grow through marketplace optimization, paid media, content systems, livestream commerce, and performance marketing."
      ...
      <section className="bg-[#F8F7FF] py-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
          ...
          <div className="bg-white border border-[#E8E6F8] rounded-2xl p-8 text-center">
            ...
            <p className="mt-2 text-sm text-[#4B4680]">Every engagement is scoped to your specific goals and budget. Reach out to discuss.</p>
      ...
      <ServiceCTA
        heading="Ready to grow your marketplace revenue?"
        body="Let's build a marketing system that converts. Reach out to discuss your channels, goals, and budget."
        primaryCta={{ label: 'Grow My Business', href: '/contact' }}
